      ...
      <View>
        <View style={{ padding: 24 }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 16, marginTop: 32 }}>
            ...
            <Text style={{ color: '#898996', fontSize: 16, fontWeight: '400' }}>Or</Text>
            <View style={{ flex: 1, height: 1, width: 140, backgroundColor: '#E6E6E8' }} />
          </View>
          ...
          >
            <Image source={{ uri: '/Images/apple.png' }} style={{ width: 18, height: 18 }} />

            <Text style={{ color: '#073937', fontSize: 14, fontWeight: '400' }}>
              Sign in with Apple
            </Text>
          </Button>
          ...
          >
            <Image source={{ uri: '/Images/google.png' }} style={{ width: 24, height: 24 }} />
